...
# Use slow corner library (example)
...
# Timing Report (10 critical paths)
...
# Gate Count Report (optional but useful for lab)
report_gates                          > reports/gate_report.rpt

# Check Design (warnings/errors)
...
puts "==============================="
puts "  SYNTHESIS & REPORTS COMPLETE "
puts "==============================="
